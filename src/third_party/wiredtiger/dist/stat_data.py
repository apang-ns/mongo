...
connection_stats = [
    ...
    DhandleStat('dh_evict_lru_walk_pass_intr_while_inuse', 'evict lru walk pass intr'),
    DhandleStat('dh_evict_lru_walk_lock_err_while_inuse', 'evict lru walk lock err'),
    ...
    DhandleStat('dh_evict_lru_walk_leak_conn_destroy', 'evict lru walk leak conn destroy'),
    DhandleStat('dh_evict_lru_walk_leak_conn_sweep', 'evict lru walk leak conn sweep'),
    DhandleStat('dh_evict_lru_walk_leak_count_during_sweep', 'evict lru walk leak count during conn sweep'),
...
##########################################
    ...
    TxnStat('txn_checkpoint_meta_ckptlist_set', 'transaction checkpoint meta ckptlist set', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_cache_op_time', 'transaction checkpoint tree helper cache op time (usecs)'),
