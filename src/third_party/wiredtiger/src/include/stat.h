...
struct __wt_connection_stats {
	...
	int64_t txn_checkpoint_dhandle_with_ckpt;
	...
	int64_t txn_checkpoint_meta_ckptlist_set;
	...
	int64_t txn_checkpoint_cache_op_time;
