...
#define	WT_CONN_CKPT_METADATA_FAST_PARSER 0x0000004u
...
#define	WT_CONN_EVICTION_NO_LOOKASIDE	0x0000200u
#define	WT_CONN_EVICTION_RUN		0x0000400u
#define	WT_CONN_IN_MEMORY		0x0000800u
#define	WT_CONN_LEAK_MEMORY		0x0001000u
#define	WT_CONN_LOOKASIDE_OPEN		0x0002000u
