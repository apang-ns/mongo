...
/* AUTOMATIC FLAG VALUE GENERATION START */
#define	WT_CONN_BT_APPLY_ESWEEP		0x00000001u
#define	WT_CONN_CACHE_CURSORS		0x00000002u
#define	WT_CONN_CACHE_POOL		0x00000004u
#define	WT_CONN_CKPT_METADATA_FAST_PARSER 0x00000008u
#define	WT_CONN_CKPT_PREP_NOSWEEP	0x00000010u
#define	WT_CONN_CKPT_SYNC		0x00000020u
#define	WT_CONN_CLOSING			0x00000040u
#define	WT_CONN_CLOSING_NO_MORE_OPENS	0x00000080u
#define	WT_CONN_CLOSING_TIMESTAMP	0x00000100u
