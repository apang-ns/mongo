...
static const WT_CONFIG_CHECK confchk_wiredtiger_open[] = {
	...
	{ "checkpoint", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_checkpoint_subconfigs, 2 },
	{ "checkpoint_metadata_fast_parser", "boolean",
	    NULL, NULL,
	    NULL, 0 },
...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "wiredtiger_open",
	  ...
	  ",cache_overhead=8,cache_size=100MB,checkpoint=(log_size=0,"
	  "wait=0),checkpoint_metadata_fast_parser=false,"
	  "checkpoint_prepare_nosweep=false,checkpoint_sync=true,"
	  ...
	  "salvage=false,session_cursor_cache_size=8192,"
	...
	{ "wiredtiger_open_basecfg",
	  ...
	  "session_cursor_cache_size=8192,session_dhhash_size=8192,"
